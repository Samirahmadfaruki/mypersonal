...
function TeacherAssignmentPage() {
  ...
  return (
    <><TeacherNavbar /><div className="teacher-assignment-page">
      {showAddModal && (
        <AddAssignmentModal
      ...
      {showEditModal && (
        <EditTeacherAssignmentModal
          ...
          onEditTeacherAssignment={(assignmentId, updatedTeacherAssignment) => handleEditTeacherAssignment(assignmentId, updatedTeacherAssignment)}
